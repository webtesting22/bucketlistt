...
import { Eye, EyeOff, Loader2, Upload, User, Store } from "lucide-react";
    ...
    <Card className="w-full shadow-lg max-h-[90vh] overflow-y-auto">
      ...
      <form onSubmit={handleSubmit}>
        <CardContent className="space-y-4">
          {/* Role Selection - Fixed to Traveller */}
          ...
          <div className="space-y-3">
            <div className="text-center">
              <a
                href="/partner"
                className="text-orange-500 hover:text-orange-600 underline text-sm font-bold"
              >
