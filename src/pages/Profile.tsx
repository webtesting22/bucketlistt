            ...
            <Card className="bg-white">
              <CardContent className={`${isMobile ? 'p-4' : 'p-6'}`}>
                <div className={`text-center ${isMobile ? 'mb-4' : 'mb-6'}`}>
                  <Avatar className={`${isMobile ? 'h-16 w-16' : 'h-20 w-20'} mx-auto ${isMobile ? 'mb-3' : 'mb-4'} border-4 border-[#940fdb]/30`}>
                  ...
                  <h2 className={`${isMobile ? 'text-lg' : 'text-xl'} font-bold mb-1 text-[#6a0fb5]`}>{getDisplayName()}</h2>
                  <Button 
                    variant="ghost" 
                    className={`text-[#940fdb] hover:bg-[#940fdb]/10 ${isMobile ? 'text-xs' : 'text-sm'} ${isMobile ? 'px-3 py-1' : ''}`}
