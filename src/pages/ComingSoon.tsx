            ...
            <CardContent className="p-12">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="flex items-center gap-3 p-4 bg-white/50 dark:bg-black/20 rounded-lg">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-muted-foreground">Earn points for every booking</p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <Button 
                  ...
                  className="bg-gradient-to-r from-brand-primary to-brand-secondary hover:from-brand-primary-dark hover:to-warning text-white px-8 py-3 text-lg"
                >
                  Back to Profile
                </Button>
